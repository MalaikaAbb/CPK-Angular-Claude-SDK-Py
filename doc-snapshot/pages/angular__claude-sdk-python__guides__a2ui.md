...
- [Dynamic catalog](/angular/claude-sdk-python/features#declarative-gen-ui)
- [Fixed schema](/angular/claude-sdk-python/features#a2ui-fixed-schema)
- [Recovery behavior](/angular/claude-sdk-python/features#a2ui-recovery)
- [Other generative UI paths](/angular/claude-sdk-python/guides/frontend-tools-generative-ui)
