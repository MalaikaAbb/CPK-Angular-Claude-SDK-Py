 ...
 * exactly once.
 *
 * Groups mirror the sidebar at https://docs.copilotkit.ai/angular/claude-sdk-python as of
 ...
 */
export const DOCS_ROOT = 'https://docs.copilotkit.ai/angular/claude-sdk-python';
    ...
    routes: [
      {
        path: '/',
        title: 'Introduction',
        docPath: '/angular/claude-sdk-python',
      ...
      },
      {
        ...
        hasDemo: true,
        title: 'Quickstart',
        docPath: '/angular/claude-sdk-python/quickstart',
        summary:
          'The smallest end-to-end path: an HttpAgent bound to the Claude Agent SDK Python backend in Copilot Runtime, provideCopilotKit, and one copilot-chat.',
        status: 'working',
      },
    ],
  },
    ...
    routes: [
      {
        ...
        docPath: '/angular/claude-sdk-python/guides/chat-ui',
        summary:
      ...
      },
      {
        ...
        docPath: '/angular/claude-sdk-python/guides/a2ui',
        summary:
      ...
      },
      {
        ...
        docPath: '/angular/claude-sdk-python/guides/voice-multimodal',
        summary:
      ...
      },
      {
        ...
        docPath: '/angular/claude-sdk-python/guides/human-in-the-loop',
        summary:
      ...
      },
      {
        ...
        docPath: '/angular/claude-sdk-python/guides/shared-state',
        summary:
    ...
    routes: [
      {
        ...
        hasDemo: true,
        title: 'Threads',
        docPath: '/angular/claude-sdk-python/guides/threads-memory-attachments-headless',
        summary:
